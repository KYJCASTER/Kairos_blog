            ...
            <div className="grid sm:grid-cols-[auto_1fr] gap-8 items-start">
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 shrink-0">
                ...
                <img
                  ...
                  alt={site.author}
                  className="relative w-full h-full rounded-2xl object-cover border hairline-strong transition-transform duration-500 ease-[cubic-bezier(0.34,1.36,0.64,1)] hover:scale-[1.04] hover:rotate-[-3deg]"
                />
              </div>
