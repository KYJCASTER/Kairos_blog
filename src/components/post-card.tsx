    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <h3 className="serif text-base font-medium text-foreground group-hover:text-primary transition-colors line-clamp-1">
            {post.title}
          </h3>
        </div>
        <ArrowUpRight className="w-4 h-4 text-muted-light group-hover:text-primary group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-all shrink-0" />
      </Link>
    )
  }
      ...
      <Link href={`/blog/${post.slug}`} className="group block">
        <article className="card overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            <div
              className="aspect-[16/10] md:aspect-auto md:min-h-[260px] relative overflow-hidden"
              style={coverStyle}
            >
              <span className="absolute inset-0 flex items-center justify-center serif text-7xl font-bold text-white/30 select-none">
            ...
            <div className="p-6 sm:p-8 flex flex-col">
              ...
              <h3 className="serif text-2xl sm:text-3xl font-semibold leading-tight mb-3 text-foreground group-hover:text-primary transition-colors">
                {post.title}
              </h3>
    ...
    <Link href={`/blog/${post.slug}`} className="group block h-full">
      <article className="card h-full overflow-hidden flex flex-col">
        <div
          ...
          style={coverStyle}
        >
          <span className="absolute inset-0 flex items-center justify-center serif text-5xl font-bold text-white/30 select-none">
            {post.title.slice(0, 1)}
          </span>
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          <h3 className="serif text-lg font-semibold leading-snug mb-2 text-foreground group-hover:text-primary transition-colors line-clamp-2">
            {post.title}
          </h3>
          ...
          <div className="flex items-center justify-between text-xs text-muted-light mt-auto pt-3 border-t hairline">
            ...
            <ArrowUpRight className="w-4 h-4 group-hover:text-primary group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-all" />
          </div>
        </div>
      </article>
    </Link>
